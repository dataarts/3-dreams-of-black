...
ROME.AnimalShader = {
	...
	globals: {
		...
		vectorA: new THREE.Vector3( 1, 1, 1 ),
		vectorB: new THREE.Vector3( 1, 1, 1 ),
		vectorC: new THREE.Vector3( 1, 1, 1 ),
		vectorD: new THREE.Vector3( 1, 1, 1 ),
		vectorE: new THREE.Vector3( 1, 1, 1 )
	...
	uniforms: function () {
		...
		return {
					...
					"vectorA": 						{ type: "v3", value: undefined },
					"vectorB": 						{ type: "v3", value: undefined },
					"vectorC": 						{ type: "v3", value: undefined },
					"vectorD": 						{ type: "v3", value: undefined },
					"vectorE": 						{ type: "v3", value: undefined }
...
*/
	...
	fragmentShader: [
		...
		"uniform 	vec3		vectorD;",
		"uniform 	vec3		vectorE;",
		...
		"void main() {",
			...
			"gl_FragColor = vec4( gl_FragColor.rgb * vectorA, 1.0 );",
			"gl_FragColor = vec4( gl_FragColor.rgb * vectorB, 1.0 );",
			"gl_FragColor = vec4( gl_FragColor.rgb * vectorC, 1.0 );",
			"gl_FragColor = vec4( gl_FragColor.rgb * vectorD, 1.0 );",
			"gl_FragColor = vec4( gl_FragColor.rgb * vectorE, 1.0 );",
...
/*			var m, ml;
			...
			material.uniforms.vectorA.value = ROME.AnimalShader.globals.vectorA;
			material.uniforms.vectorB.value = ROME.AnimalShader.globals.vectorB;
			material.uniforms.vectorC.value = ROME.AnimalShader.globals.vectorC;
			material.uniforms.vectorD.value = ROME.AnimalShader.globals.vectorD;
			material.uniforms.vectorE.value = ROME.AnimalShader.globals.vectorE;
