 ...
 */
		...
		/*
		 * TODO!
		 * Varje chunk är ett shader program!
		 * Just nu är det kodat lite så att varje material är det, men det är fel
		 * Om däremot ett MeshFaceMaterial finns, så är de faces som har det materialet samlat
		 * i en chunk som därför ska ha det materialet, resten ska ha de andra materialen
		 * 
		 * Att göra: kompilera ihop material som inte är MeshShaderMaterial, som till exempel
		 * lambert och så vidare. Och göra stöd för wireframe.
		 * 
		 * Jag har precis gjort laddningen över till GPUn men inte matchat mot shader programet
		 */
