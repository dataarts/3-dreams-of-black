...
TEMPLATE_LINK = """<a href="#" onclick="document.getElementById('animals').src = 'dunes_%s.html';">%s</a>"""
...
if __name__ == "__main__":
    ...
    linkspath = os.path.join(HTMLPATH, "dunes.html")
