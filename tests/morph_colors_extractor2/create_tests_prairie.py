...
<title>three.js webgl - %(title)s - prairie</title>
...
function addAnimal( geometry ) {
    ...
    morphObject.animalA.timeScale = morphObject.animalB.timeScale = 1;
...
<title>rome - animals - prairie</title>
...
TEMPLATE_LINK = """<a href="#" onclick="document.getElementById('animals').src = 'prairie_%s.html';">%s</a>"""
...
if __name__ == "__main__":
    ...
    for jsname in jsfiles:
        ...
        htmlname = "prairie_%s.html" % bname
    ...
    linkspath = os.path.join(HTMLPATH, "prairie.html")
