...
TEMPLATE_LINK = """<a href="#" onclick="document.getElementById('animals').src = 'white_city_%s.html';">%s</a>"""
...
if __name__ == "__main__":
    ...
    for jsname in jsfiles:
        ...
        htmlname = "white_city_%s.html" % bname
    ...
    linkspath = os.path.join(HTMLPATH, "white_city.html")
