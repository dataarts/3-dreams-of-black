...
THREE.Object3D.prototype = {
	...
	updateMatrix: function () {
		...
		rotationMatrix.setRotationX( r.x );

		if ( r.y != 0 ) rotationMatrix.multiplySelf( tmpMatrix.setRotationY( r.y ) );
		if ( r.z != 0 ) rotationMatrix.multiplySelf( tmpMatrix.setRotationZ( r.z ) );
