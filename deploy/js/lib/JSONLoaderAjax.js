...
THREE.JSONLoaderAjax = function ( showStatus ) {
...
THREE.JSONLoaderAjax.prototype.load = function ( parameters ) {
	...
	THREE.JSONLoaderAjax.prototype.loadAjaxJSON( this, url, callback, texture_path );

};

THREE.JSONLoaderAjax.prototype.loadAjaxJSON = function( context, url, callback, texturePath, callbackProgress ) {
	...
	xhr.onreadystatechange = function() {
		...
		if ( xhr.readyState == 4 ) {
			...
			if ( xhr.status == 200 || xhr.status == 0 ) {
				...
				THREE.JSONLoaderAjax.prototype.createModel( jsonObject, callback, texturePath );
...
THREE.JSONLoaderAjax.prototype.createModel = function ( json, callback, texture_path ) {
