...
THREE.SceneLoaderAjax.prototype.load = function( url, callbackFinished ) {
...
THREE.SceneLoaderAjax.prototype.createScene = function ( json, callbackFinished, url ) {
	...
	jsonLoader = new THREE.JSONLoaderAjax();
