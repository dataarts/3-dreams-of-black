...
*/
			var moveNormalX = (toNormal.x-normal.x)/5;
			var moveNormalY = (toNormal.y-normal.y)/5;
			var moveNormalZ = (toNormal.z-normal.z)/5;
			...
			if (distance < 15 && positionArray != null) {
