...
ROME.Animal_old = function( geometry, parseMorphTargetsNames, color ) {

	// construct
	/*var material = new THREE.MeshShaderMaterial( {
		uniforms: ROME.AnimalShader_old.uniforms(),
		vertexShader: ROME.AnimalShader_old.vertex(),
		fragmentShader: ROME.AnimalShader_old.fragment(),
		morphTargets: true,
		lights: true
	} );*/
	...
	var material = new THREE.MeshShaderMaterial( { uniforms:       ROME.AnimalShader_old.uniforms(), 
												   vertexShader:   ROME.AnimalShader_old.vertex(), 
												   fragmentShader: ROME.AnimalShader_old.fragment(),
												   morphTargets:   true,
	...
	that.availableAnimals = ROME.AnimalAnimationData_old.init( geometry, parseMorphTargetsNames );
	...
	var setAnimalData = function( name, data ) {
		...
		if( ROME.AnimalAnimationData_old[ name ] !== undefined ) {

			data.frames         = ROME.AnimalAnimationData_old[ name ];
